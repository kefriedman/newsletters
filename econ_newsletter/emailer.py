...
def get_active_subscribers() -> list[str]:
    ...
    spreadsheet_id = os.environ.get("ECON_SPREADSHEET_ID")
    if not spreadsheet_id:
        print("Warning: ECON_SPREADSHEET_ID not set")
        return []
...
def send_newsletter(
    ...
    Args:
        ...
        recipient: Override recipient (optional, for backwards compatibility)
    ...
    if not gmail_address or not gmail_app_password:
        ...
        print("Required: GMAIL_ADDRESS, GMAIL_APP_PASSWORD")
        return False
...
def send_test_email(recipient: str | None = None) -> bool:
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, sans-serif; padding: 20px; background-color: #0f0f1a; color: #e2e8f0;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #1a1a2e; padding: 30px; border-radius: 12px;">
            <h1 style="color: #38a169; margin-top: 0;">Test Email</h1>
            <p>If you're reading this, your Economics Newsletter email configuration is working correctly!</p>
            <p>What You Need to Know: Economics will be sent to this address every Tuesday morning.</p>
        </div>
    </body>
    </html>
    """
    ...
    return send_newsletter(
        ...
        subject="What You Need to Know: Economics - Test Email",
        recipient=recipient
    )
